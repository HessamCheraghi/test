...
const config = {
    ...
    data: {
        datasets: [
            {
                borderColor: (0, _utils.CHART_COLORS).red,
                borderWidth: 1,
                radius: 0,
                data: data
            },
            {
                borderColor: (0, _utils.CHART_COLORS).blue,
                borderWidth: 1,
                radius: 0,
                data: data2
            }, 
...
////////////////////////////////////////
const myChart = new (0, _autoDefault.default)(document.querySelector("#myChart"), config);
...
},{"chart.js/auto":"6r6LS","./utils":"bIDtH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","chartjs-plugin-zoom":"kMtu7"}],"6r6LS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _chartEsmJs = require("../dist/chart.esm.js");
(0, _chartEsmJs.Chart).register(...(0, _chartEsmJs.registerables));
exports.default = (0, _chartEsmJs.Chart);

},{"../dist/chart.esm.js":"khwgE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"khwgE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class DatasetController {
    ...
    _resolveElementOptions(elementType, mode = "default", index13) {
        ...
        const sharing = this.enableOptionSharing && (0, _helpersSegmentJs.j)(index13);
...
class LineController extends DatasetController {
    ...
    updateElements(points, start, count, mode) {
        ...
        const maxGapLength = (0, _helpersSegmentJs.q)(spanGaps) ? spanGaps : Number.POSITIVE_INFINITY;
...
function binarySearch(metaset, axis, value, intersect) {
    ...
    if (iScale && axis === iScale.axis && axis !== "r" && _sorted && data.length) {
        const lookupMethod = iScale._reversePixels ? (0, _helpersSegmentJs.A) : (0, _helpersSegmentJs.x);
...
function evaluateInteractionItems(chart, axis, position, handler, intersect) {
    ...
    for(let i = 0, ilen = metasets.length; i < ilen; ++i){
        const { index: index36 , data  } = metasets[i];
...
function getNearestRadialItems(chart, position, axis, useFinalPosition) {
    ...
    function evaluationFunc(element, datasetIndex, index38) {
        ...
        const { angle  } = (0, _helpersSegmentJs.C)(element, {
            x: position.x,
            y: position.y
        });
...
function getAxisItems(chart, position, axis, intersect, useFinalPosition) {
    ...
    evaluateInteractionItems(chart, axis, position, (element, datasetIndex, index40)=>{
...
var layouts = {
    ...
    update (chart, width, height, minPadding) {
        if (!chart) return;
        const padding = (0, _helpersSegmentJs.D)(chart.options.layout.padding);
        const availableWidth = Math.max(width - padding.width, 0);
        const availableHeight = Math.max(height - padding.height, 0);
        const boxes = buildLayoutBoxes(chart.boxes);
        const verticalBoxes = boxes.vertical;
        const horizontalBoxes = boxes.horizontal;
        (0, _helpersSegmentJs.E)(chart.boxes, (box)=>{
        ...
        (0, _helpersSegmentJs.E)(boxes.chartArea, (layout)=>{
            const box = layout.box;
...
function createResizeObserver(chart, type, listener) {
    const canvas = chart.canvas;
    const container = canvas && (0, _helpersSegmentJs.G)(canvas);
    if (!container) return;
    const resize = (0, _helpersSegmentJs.J)((width, height)=>{
...
function createProxyAndListen(chart, type, listener) {
    const canvas = chart.canvas;
    const proxy = (0, _helpersSegmentJs.J)((event)=>{
...
class DomPlatform extends BasePlatform {
    ...
    isAttached(canvas) {
        const container = (0, _helpersSegmentJs.G)(canvas);
...
const formatters = {
    ...
    numeric (tickValue, index, ticks) {
        ...
        const logDelta = (0, _helpersSegmentJs.M)(Math.abs(delta));
    ...
    logarithmic (tickValue, index43, ticks) {
        if (tickValue === 0) return "0";
        const remain = tickValue / Math.pow(10, Math.floor((0, _helpersSegmentJs.M)(tickValue)));
...
function garbageCollect(caches, length) {
    (0, _helpersSegmentJs.E)(caches, (cache)=>{
        const gc = cache.gc;
...
function getTitleHeight(options, fallback) {
    ...
    const font = (0, _helpersSegmentJs.$)(options.font, fallback);
    const padding = (0, _helpersSegmentJs.D)(options.padding);
...
function titleAlign(align, position, reverse) {
    let ret = (0, _helpersSegmentJs.a0)(align);
...
class Scale extends Element {
    ...
    calculateLabelRotation() {
        ...
        const maxWidth = (0, _helpersSegmentJs.w)(this.chart.width - maxLabelWidth, 0, this.maxWidth);
    ...
    _computeLabelItems(chartArea) {
        ...
        for(i = 0, ilen = ticks.length; i < ilen; ++i){
            ...
            if (optsAtIndex.showLabelBackdrop) {
                const labelPadding = (0, _helpersSegmentJs.D)(optsAtIndex.backdropPadding);
    ...
    drawTitle() {
        ...
        const font = (0, _helpersSegmentJs.$)(title.font);
        const padding = (0, _helpersSegmentJs.D)(title.padding);
...
function registerDefaults(item, scope, parentScope) {
    const itemDefaults = (0, _helpersSegmentJs.a3)(Object.create(null), [
...
class Registry {
    ...
    _each(method, args, typedRegistry) {
        [
            ...
            else (0, _helpersSegmentJs.E)(arg, (item)=>{
    ...
    _exec(method, registry1, component) {
        const camelMethod = (0, _helpersSegmentJs.a4)(method);
...
function mergeScaleConfig(config, options) {
    const chartDefaults = (0, _helpersSegmentJs.a2)[config.type] || {
        scales: {}
    };
    ...
    config.data.datasets.forEach((dataset)=>{
        ...
        const datasetDefaults = (0, _helpersSegmentJs.a2)[type] || {};
...
class Config {
    ...
    getOptionScopes(mainScope, keyLists, resetCache) {
        ...
        keyLists.forEach((keys)=>{
            ...
            keys.forEach((key)=>addIfFound(scopes, (0, _helpersSegmentJs.a2)[type] || {}, key));
            keys.forEach((key)=>addIfFound(scopes, (0, _helpersSegmentJs.d), key));
            keys.forEach((key)=>addIfFound(scopes, (0, _helpersSegmentJs.a5), key));
        });
...
function getResolver(resolverCache, scopes, prefixes) {
    ...
    if (!cached) {
        const resolver = (0, _helpersSegmentJs.a8)(scopes, prefixes);
        cached = {
            resolver,
...
const hasFunction = (value)=>(0, _helpersSegmentJs.i)(value) && Object.getOwnPropertyNames(value).reduce((acc, key)=>acc || (0, _helpersSegmentJs.a6)(value[key]), false);
function needContext(proxy, names) {
    const { isScriptable , isIndexable  } = (0, _helpersSegmentJs.a9)(proxy);
...
class Chart {
    constructor(item, userConfig){
        ...
        this.$context = undefined;
        this._doResize = (0, _helpersSegmentJs.ac)((mode)=>this.update(mode), options.resizeDelay || 0);
        this._dataChanges = [];
    ...
    ensureScalesHaveIDs() {
        ...
        (0, _helpersSegmentJs.E)(scalesOptions, (axisOptions, axisID)=>{
    ...
    buildOrUpdateScales() {
        ...
        (0, _helpersSegmentJs.E)(items, (item)=>{
        ...
        (0, _helpersSegmentJs.E)(updated, (hasUpdated, id)=>{
            if (!hasUpdated) delete scales4[id];
        });
        (0, _helpersSegmentJs.E)(scales4, (scale)=>{
    ...
    _resetElements() {
        (0, _helpersSegmentJs.E)(this.data.datasets, (dataset, datasetIndex)=>{
    ...
    update(mode) {
        ...
        if (!animsDisabled) (0, _helpersSegmentJs.E)(newControllers, (controller)=>{
            controller.reset();
        });
    ...
    _updateScales() {
        (0, _helpersSegmentJs.E)(this.scales, (scale)=>{
    ...
    _updateLayout(minPadding) {
        ...
        this._layers = [];
        (0, _helpersSegmentJs.E)(this.boxes, (box)=>{
    ...
    _updateDatasets(mode) {
        ...
        for(let i5 = 0, ilen1 = this.data.datasets.length; i5 < ilen1; ++i5)this._updateDataset(i5, (0, _helpersSegmentJs.a6)(mode) ? mode({
            datasetIndex: i5
        }) : mode);
    ...
    bindUserEvents() {
        ...
        (0, _helpersSegmentJs.E)(this.options.events, (type)=>_add(type, listener1));
    }
    ...
    unbindEvents() {
        (0, _helpersSegmentJs.E)(this._listeners, (listener, type)=>{
            this.platform.removeEventListener(this, type, listener);
        });
        this._listeners = {};
        (0, _helpersSegmentJs.E)(this._responsiveListeners, (listener, type)=>{
            this.platform.removeEventListener(this, type, listener);
        });
        this._responsiveListeners = undefined;
    }
    ...
    setActiveElements(activeElements) {
        ...
        const changed = !(0, _helpersSegmentJs.ag)(active, lastActive);
        if (changed) {
            this._active = active;
    ...
    _handleEvent(e, replay, inChartArea) {
        ...
        const isClick = (0, _helpersSegmentJs.ah)(e);
...
const invalidatePlugins = ()=>(0, _helpersSegmentJs.E)(Chart.instances, (chart)=>chart._plugins.invalidate());
...
class ArcElement extends Element {
    ...
    inRange(chartX, chartY, useFinalPosition) {
        ...
        const { angle , distance  } = (0, _helpersSegmentJs.C)(point, {
            x: chartX,
            y: chartY
        });
        ...
        const withinRadius = (0, _helpersSegmentJs.ai)(distance, innerRadius + rAdjust, outerRadius + rAdjust);
...
class LineElement extends Element {
    ...
    interpolate(point, property) {
        ...
        const points = this.points;
        const segments = (0, _helpersSegmentJs.am)(this, {
            property,
            start: value,
            end: value
        });
...
function parseBorderWidth(bar, maxW, maxH) {
    ...
    const o = (0, _helpersSegmentJs.au)(value);
    return {
...
class BarElement extends Element {
    ...
    draw(ctx) {
        ...
        const addRectPath = hasRadius(outer.radius) ? (0, _helpersSegmentJs.at) : addNormalRectPath;
        ctx.save();
...
function _segments(line, target, property) {
    ...
    for (const segment of segments){
        ...
        const targetSegments = (0, _helpersSegmentJs.am)(target, bounds);
        for (const tgt of targetSegments){
            const subBounds = _getBounds(property, tpoints[tgt.start], tpoints[tgt.end], tgt.loop);
            const fillSources = (0, _helpersSegmentJs.aw)(segment, points, subBounds);
...
var index = {
    ...
    beforeDraw (chart, _args, options) {
        ...
        for(let i = metasets.length - 1; i >= 0; --i){
            ...
            if (draw2) _drawfill(chart.ctx, source, area);
        }
    },
...
class Legend extends Element {
    ...
    fit() {
        ...
        const labelFont = (0, _helpersSegmentJs.$)(labelOpts.font);
    ...
    adjustHitBoxes() {
        ...
        const rtlHelper = (0, _helpersSegmentJs.ay)(rtl, this.left, this.width);
        if (this.isHorizontal()) {
            let row = 0;
            let left = (0, _helpersSegmentJs.a1)(align, this.left + padding, this.right - this.lineWidths[row]);
            ...
            let col = 0;
            let top = (0, _helpersSegmentJs.a1)(align, this.top + titleHeight + padding, this.bottom - this.columnSizes[col].height);
            for (const hitbox of hitboxes){
                if (hitbox.col !== col) {
                    col = hitbox.col;
    ...
    _draw() {
        ...
        const rtlHelper = (0, _helpersSegmentJs.ay)(opts.rtl, this.left, this.width);
        const labelFont = (0, _helpersSegmentJs.$)(labelOpts.font);
        ...
        const drawLegendBox = function(x, y, legendItem) {
            ...
            if (labelOpts.usePointStyle) {
                ...
                const borderRadius = (0, _helpersSegmentJs.av)(legendItem.borderRadius);
                ctx.beginPath();
                if (Object.values(borderRadius).some((v)=>v !== 0)) (0, _helpersSegmentJs.at)(ctx, {
                    x: xBoxLeft,
                    y: yBoxTop,
                    w: boxWidth,
                    h: boxHeight,
        ...
        this.legendItems.forEach((legendItem, i)=>{
            ...
            if (isHorizontal) {
                if (i > 0 && x + width + padding > this.right) {
                    ...
                    cursor.line++;
                    x = cursor.x = (0, _helpersSegmentJs.a1)(align, this.left + padding, this.right - lineWidths[cursor.line]);
                }
            } else if (i > 0 && y + lineHeight > this.bottom) {
                x = cursor.x = x + columnSizes[cursor.line].width + padding;
                cursor.line++;
                y = cursor.y = (0, _helpersSegmentJs.a1)(align, this.top + titleHeight + padding, this.bottom - columnSizes[cursor.line].height);
            }
            const realX = rtlHelper.x(x);
            drawLegendBox(realX, y, legendItem);
            x = (0, _helpersSegmentJs.aA)(textAlign, x + boxWidth + halfFontSize, isHorizontal ? x + width : this.right, opts.rtl);
    ...
    drawTitle() {
        ...
        const titleFont = (0, _helpersSegmentJs.$)(titleOpts.font);
        const titlePadding = (0, _helpersSegmentJs.D)(titleOpts.padding);
        ...
        const x = (0, _helpersSegmentJs.a1)(position, left, left + maxWidth);
        ...
        labels: {
            ...
            generateLabels (chart) {
                ...
                return chart._getSortedDatasetMetas().map((meta)=>{
                    ...
                    const borderWidth = (0, _helpersSegmentJs.D)(style.borderWidth);
                    return {
...
class Title extends Element {
    ...
    update(maxWidth, maxHeight) {
        ...
        const textSize = lineCount * (0, _helpersSegmentJs.$)(opts.font).lineHeight + this._padding.height;
    ...
    draw() {
        ...
        const fontOpts = (0, _helpersSegmentJs.$)(opts.font);
    ...
    nearest (items, eventPosition) {
        ...
        for(i = 0, len = items.length; i < len; ++i){
            ...
            if (el && el.hasValue()) {
                ...
                const d = (0, _helpersSegmentJs.aD)(eventPosition, center);
                if (d < minDistance) {
                    minDistance = d;
                    nearestElement = el;
                }
...
function getTooltipSize(tooltip, options) {
    ...
    const bodyFont = (0, _helpersSegmentJs.$)(options.bodyFont);
    const titleFont = (0, _helpersSegmentJs.$)(options.titleFont);
    const footerFont = (0, _helpersSegmentJs.$)(options.footerFont);
    ...
    (0, _helpersSegmentJs.E)(body, (bodyItem)=>{
...
function getBackgroundPoint(options, size, alignment, chart) {
    ...
    const { topLeft , topRight , bottomLeft , bottomRight  } = (0, _helpersSegmentJs.av)(cornerRadius);
...
class Tooltip extends Element {
    ...
    getBody(tooltipItems, options) {
        const { callbacks  } = options;
        const bodyItems = [];
        (0, _helpersSegmentJs.E)(tooltipItems, (context)=>{
            const bodyItem = {
                before: [],
                lines: [],
                after: []
    ...
    drawTitle(pt, ctx, options) {
        ...
        if (length) {
            const rtlHelper = (0, _helpersSegmentJs.ay)(options.rtl, this.x, this.width);
    ...
    _drawColorBox(ctx, pt, i, rtlHelper, options) {
        ...
        if (options.usePointStyle) {
            ...
            const borderRadius = (0, _helpersSegmentJs.av)(labelColors.borderRadius);
    ...
    drawBackground(pt, ctx, tooltipSize, options) {
        ...
        const { topLeft , topRight , bottomLeft , bottomRight  } = (0, _helpersSegmentJs.av)(options.cornerRadius);
        ctx.fillStyle = options.backgroundColor;
        ctx.strokeStyle = options.borderColor;
        ctx.lineWidth = options.borderWidth;
        ctx.beginPath();
    ...
    setActiveElements(activeElements, eventPosition) {
        ...
        const changed = !(0, _helpersSegmentJs.ag)(lastActive, active);
    ...
    handleEvent(e, replay, inChartArea = true) {
        ...
        const changed = replay || !(0, _helpersSegmentJs.ag)(active, lastActive) || positionChanged;
        if (changed) {
            this._active = active;
...
const validIndex = (index69, max)=>index69 === null ? null : (0, _helpersSegmentJs.w)(Math.round(index69), 0, max);
...
function generateTicks$1(generationOptions, dataRange) {
    ...
    let spacing = (0, _helpersSegmentJs.aF)((rmax - rmin) / maxSpaces / unit) * unit;
    ...
    const decimalPlaces = Math.max((0, _helpersSegmentJs.aI)(spacing), (0, _helpersSegmentJs.aI)(niceMin));
...
function isMajor(tickVal) {
    const remain = tickVal / Math.pow(10, Math.floor((0, _helpersSegmentJs.M)(tickVal)));
    return remain === 1;
}
function generateTicks(generationOptions, dataRange) {
    const endExp = Math.floor((0, _helpersSegmentJs.M)(dataRange.max));
    const endSignificand = Math.ceil(dataRange.max / Math.pow(10, endExp));
    const ticks = [];
    let tickVal = (0, _helpersSegmentJs.O)(generationOptions.min, Math.pow(10, Math.floor((0, _helpersSegmentJs.M)(dataRange.min))));
    let exp = Math.floor((0, _helpersSegmentJs.M)(tickVal));
    ...
    const lastTick = (0, _helpersSegmentJs.O)(generationOptions.max, tickVal);
    ticks.push({
        value: lastTick,
        major: isMajor(tickVal)
    });
...
class LogarithmicScale extends Scale {
    ...
    handleTickRangeOptions() {
        ...
        const setMin = (v)=>min = minDefined ? min : v;
        const setMax = (v)=>max = maxDefined ? max : v;
        const exp = (v, m)=>Math.pow(10, Math.floor((0, _helpersSegmentJs.M)(v)) + m);
        if (min === max) {
            if (min <= 0) {
                setMin(1);
                setMax(10);
...
function getTickBackdropHeight(opts) {
    ...
    if (tickOpts.display && opts.display) {
        const padding = (0, _helpersSegmentJs.D)(tickOpts.backdropPadding);
...
function fitWithPointLabels(scale) {
    ...
    for(let i = 0; i < valueCount; i++){
        ...
        const plFont = (0, _helpersSegmentJs.$)(opts.font);
        const textSize = measureLabelSize(scale.ctx, plFont, scale._pointLabels[i]);
        labelSizes[i] = textSize;
        const angleRadians = (0, _helpersSegmentJs.ax)(scale.getIndexAngle(i) + additionalAngle);
        const angle = Math.round((0, _helpersSegmentJs.S)(angleRadians));
...
function buildPointLabelItems(scale, labelSizes, padding) {
    ...
    for(let i = 0; i < valueCount; i++){
        ...
        const angle = Math.round((0, _helpersSegmentJs.S)((0, _helpersSegmentJs.ax)(pointLabelPosition.angle + (0, _helpersSegmentJs.H))));
...
function drawPointLabels(scale, labelCount) {
    ...
    for(let i = labelCount - 1; i >= 0; i--){
        ...
        const plFont = (0, _helpersSegmentJs.$)(optsAtIndex.font);
        const { x , y , textAlign , left , top , right , bottom  } = scale._pointLabelItems[i];
        const { backdropColor  } = optsAtIndex;
        if (!(0, _helpersSegmentJs.k)(backdropColor)) {
            const borderRadius = (0, _helpersSegmentJs.av)(optsAtIndex.borderRadius);
            const padding = (0, _helpersSegmentJs.D)(optsAtIndex.backdropPadding);
...
class RadialLinearScale extends LinearScaleBase {
    ...
    setDimensions() {
        const padding = this._padding = (0, _helpersSegmentJs.D)(getTickBackdropHeight(this.options) / 2);
    ...
    getPointPosition(index78, distanceFromCenter, additionalAngle = 0) {
        const angle = this.getIndexAngle(index78) - (0, _helpersSegmentJs.H) + additionalAngle;
        return {
    ...
    getPointLabelPosition(index81) {
        const { left , top , right , bottom  } = this._pointLabelItems[index81];
        return {
            left,
            top,
            right,
    ...
    drawLabels() {
        ...
        this.ticks.forEach((tick, index83)=>{
            ...
            const tickFont = (0, _helpersSegmentJs.$)(optsAtIndex.font);
...
function addTick(ticks, time, timestamps) {
    if (!timestamps) ticks[time] = true;
        ...
        const { lo , hi  } = (0, _helpersSegmentJs.aL)(timestamps, time);
...
class TimeScale extends Scale {
    ...
    buildTicks() {
        ...
        const min = this.min;
        const max = this.max;
        const ticks = (0, _helpersSegmentJs.aK)(timestamps, min, max);
    ...
    _generate() {
        ...
        const stepSize = (0, _helpersSegmentJs.v)(timeOpts.stepSize, 1);
        const weekday = minor === "week" ? timeOpts.isoWeekday : false;
        const hasWeekday = (0, _helpersSegmentJs.q)(weekday) || weekday === true;
        const ticks = {};
        let first = min;
        let time, count;
...
function interpolate(table, val, reverse) {
    ...
    if (reverse) {
        if (val >= table[lo].pos && val <= table[hi].pos) ({ lo , hi  } = (0, _helpersSegmentJs.x)(table, "pos", val));
        ({ pos: prevSource , time: prevTarget  } = table[lo]);
        ({ pos: nextSource , time: nextTarget  } = table[hi]);
    } else {
        if (val >= table[lo].time && val <= table[hi].time) ({ lo , hi  } = (0, _helpersSegmentJs.x)(table, "time", val));
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "$", ()=>toFont);
parcelHelpers.export(exports, "A", ()=>_rlookupByKey);
parcelHelpers.export(exports, "B", ()=>_isPointInArea);
parcelHelpers.export(exports, "C", ()=>getAngleFromPoint);
parcelHelpers.export(exports, "D", ()=>toPadding);
parcelHelpers.export(exports, "E", ()=>each);
parcelHelpers.export(exports, "F", ()=>getMaximumSize);
parcelHelpers.export(exports, "G", ()=>_getParentNode);
parcelHelpers.export(exports, "H", ()=>HALF_PI);
parcelHelpers.export(exports, "I", ()=>readUsedSize);
parcelHelpers.export(exports, "J", ()=>throttled);
parcelHelpers.export(exports, "K", ()=>supportsEventListenerOptions);
parcelHelpers.export(exports, "L", ()=>_isDomSupported);
parcelHelpers.export(exports, "M", ()=>log10);
...
parcelHelpers.export(exports, "S", ()=>toDegrees);
parcelHelpers.export(exports, "T", ()=>TAU);
parcelHelpers.export(exports, "U", ()=>_measureText);
parcelHelpers.export(exports, "V", ()=>_int16Range);
parcelHelpers.export(exports, "W", ()=>_alignPixel);
parcelHelpers.export(exports, "X", ()=>clipArea);
parcelHelpers.export(exports, "Y", ()=>renderText);
parcelHelpers.export(exports, "Z", ()=>unclipArea);
parcelHelpers.export(exports, "_", ()=>_arrayUnique);
parcelHelpers.export(exports, "a", ()=>resolve);
parcelHelpers.export(exports, "a$", ()=>QUARTER_PI);
parcelHelpers.export(exports, "a0", ()=>_toLeftRightCenter);
parcelHelpers.export(exports, "a1", ()=>_alignStartEnd);
parcelHelpers.export(exports, "a2", ()=>overrides);
parcelHelpers.export(exports, "a3", ()=>merge);
parcelHelpers.export(exports, "a4", ()=>_capitalize);
parcelHelpers.export(exports, "a5", ()=>descriptors);
parcelHelpers.export(exports, "a6", ()=>isFunction);
parcelHelpers.export(exports, "a7", ()=>_attachContext);
parcelHelpers.export(exports, "a8", ()=>_createResolver);
parcelHelpers.export(exports, "a9", ()=>_descriptors);
parcelHelpers.export(exports, "aA", ()=>_textX);
parcelHelpers.export(exports, "aB", ()=>restoreTextDirection);
parcelHelpers.export(exports, "aC", ()=>noop);
parcelHelpers.export(exports, "aD", ()=>distanceBetweenPoints);
parcelHelpers.export(exports, "aE", ()=>_setMinAndMaxByKey);
parcelHelpers.export(exports, "aF", ()=>niceNum);
parcelHelpers.export(exports, "aG", ()=>almostWhole);
parcelHelpers.export(exports, "aH", ()=>almostEquals);
parcelHelpers.export(exports, "aI", ()=>_decimalPlaces);
parcelHelpers.export(exports, "aJ", ()=>_longestText);
parcelHelpers.export(exports, "aK", ()=>_filterBetween);
parcelHelpers.export(exports, "aL", ()=>_lookup);
parcelHelpers.export(exports, "aM", ()=>isPatternOrGradient);
parcelHelpers.export(exports, "aN", ()=>getHoverColor);
parcelHelpers.export(exports, "aO", ()=>clone$1);
parcelHelpers.export(exports, "aP", ()=>_merger);
parcelHelpers.export(exports, "aQ", ()=>_mergerIf);
parcelHelpers.export(exports, "aR", ()=>_deprecated);
parcelHelpers.export(exports, "aS", ()=>toFontString);
parcelHelpers.export(exports, "aT", ()=>splineCurve);
parcelHelpers.export(exports, "aU", ()=>splineCurveMonotone);
parcelHelpers.export(exports, "aV", ()=>getStyle);
parcelHelpers.export(exports, "aW", ()=>fontString);
parcelHelpers.export(exports, "aX", ()=>toLineHeight);
parcelHelpers.export(exports, "aY", ()=>PITAU);
parcelHelpers.export(exports, "aZ", ()=>INFINITY);
parcelHelpers.export(exports, "a_", ()=>RAD_PER_DEG);
parcelHelpers.export(exports, "aa", ()=>mergeIf);
parcelHelpers.export(exports, "ab", ()=>uid);
parcelHelpers.export(exports, "ac", ()=>debounce);
parcelHelpers.export(exports, "ad", ()=>retinaScale);
parcelHelpers.export(exports, "ae", ()=>clearCanvas);
parcelHelpers.export(exports, "af", ()=>setsEqual);
parcelHelpers.export(exports, "ag", ()=>_elementsEqual);
parcelHelpers.export(exports, "ah", ()=>_isClickEvent);
parcelHelpers.export(exports, "ai", ()=>_isBetween);
parcelHelpers.export(exports, "aj", ()=>_readValueToProps);
parcelHelpers.export(exports, "ak", ()=>_updateBezierControlPoints);
parcelHelpers.export(exports, "al", ()=>_computeSegments);
parcelHelpers.export(exports, "am", ()=>_boundSegments);
parcelHelpers.export(exports, "an", ()=>_steppedInterpolation);
parcelHelpers.export(exports, "ao", ()=>_bezierInterpolation);
parcelHelpers.export(exports, "ap", ()=>_pointInLine);
parcelHelpers.export(exports, "aq", ()=>_steppedLineTo);
parcelHelpers.export(exports, "ar", ()=>_bezierCurveTo);
parcelHelpers.export(exports, "as", ()=>drawPoint);
parcelHelpers.export(exports, "at", ()=>addRoundedRectPath);
parcelHelpers.export(exports, "au", ()=>toTRBL);
parcelHelpers.export(exports, "av", ()=>toTRBLCorners);
parcelHelpers.export(exports, "aw", ()=>_boundSegment);
parcelHelpers.export(exports, "ax", ()=>_normalizeAngle);
parcelHelpers.export(exports, "ay", ()=>getRtlAdapter);
parcelHelpers.export(exports, "az", ()=>overrideTextDirection);
parcelHelpers.export(exports, "b", ()=>isArray);
parcelHelpers.export(exports, "b0", ()=>TWO_THIRDS_PI);
parcelHelpers.export(exports, "b1", ()=>_angleDiff);
...
var _helpersEsm = require("chart.js/helpers/helpers.esm");
var _seed = Date.now();
function srand(seed) {
    _seed = seed;
}
function rand(min, max) {
    min = (0, _helpersEsm.valueOrDefault)(min, 0);
    max = (0, _helpersEsm.valueOrDefault)(max, 0);
    _seed = (_seed * 9301 + 49297) % 233280;
    return min + _seed / 233280 * (max - min);
}
function numbers(config) {
    var cfg = config || {};
    var min = (0, _helpersEsm.valueOrDefault)(cfg.min, 0);
    var max = (0, _helpersEsm.valueOrDefault)(cfg.max, 100);
    var from = (0, _helpersEsm.valueOrDefault)(cfg.from, []);
    var count = (0, _helpersEsm.valueOrDefault)(cfg.count, 8);
    var decimals = (0, _helpersEsm.valueOrDefault)(cfg.decimals, 8);
    var continuity = (0, _helpersEsm.valueOrDefault)(cfg.continuity, 1);
    var dfactor = Math.pow(10, decimals) || 0;
    var data = [];
    var i, value;
    for(i = 0; i < count; ++i){
        value = (from[i] || 0) + rand(min, max);
        if (rand() <= continuity) data.push(Math.round(dfactor * value) / dfactor);
        else data.push(null);
    }
    return data;
}
...
},{"@kurkle/color":"2aojw","luxon":"dpK6X","chartjs-adapter-luxon":"hmCSx","chart.js/helpers/helpers.esm":"7mXAh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2aojw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Color", ()=>Color);
...
(0, _chartJs._adapters)._date.override({
   ...
   */ _create: function(time) {
    ...
    parse: function(value, format) {
        ...
        else if (type === "object" && !(value instanceof (0, _luxon.DateTime))) value = (0, _luxon.DateTime).fromObject(value);
...
},{"chart.js":"khwgE","luxon":"dpK6X"}],"7mXAh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _helpersEsm = require("../dist/helpers.esm");
parcelHelpers.exportAll(_helpersEsm, exports);

},{"../dist/helpers.esm":"ikIcl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ikIcl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*!
 * Chart.js v3.8.0
...
parcelHelpers.export(exports, "INFINITY", ()=>(0, _helpersSegmentJs.aZ));
parcelHelpers.export(exports, "PI", ()=>(0, _helpersSegmentJs.P));
parcelHelpers.export(exports, "PITAU", ()=>(0, _helpersSegmentJs.aY));
parcelHelpers.export(exports, "QUARTER_PI", ()=>(0, _helpersSegmentJs.a$));
parcelHelpers.export(exports, "RAD_PER_DEG", ()=>(0, _helpersSegmentJs.a_));
parcelHelpers.export(exports, "TAU", ()=>(0, _helpersSegmentJs.T));
parcelHelpers.export(exports, "TWO_THIRDS_PI", ()=>(0, _helpersSegmentJs.b0));
parcelHelpers.export(exports, "_addGrace", ()=>(0, _helpersSegmentJs.R));
parcelHelpers.export(exports, "_alignPixel", ()=>(0, _helpersSegmentJs.W));
parcelHelpers.export(exports, "_alignStartEnd", ()=>(0, _helpersSegmentJs.a1));
parcelHelpers.export(exports, "_angleBetween", ()=>(0, _helpersSegmentJs.p));
parcelHelpers.export(exports, "_angleDiff", ()=>(0, _helpersSegmentJs.b1));
parcelHelpers.export(exports, "_arrayUnique", ()=>(0, _helpersSegmentJs._));
parcelHelpers.export(exports, "_attachContext", ()=>(0, _helpersSegmentJs.a7));
parcelHelpers.export(exports, "_bezierCurveTo", ()=>(0, _helpersSegmentJs.ar));
parcelHelpers.export(exports, "_bezierInterpolation", ()=>(0, _helpersSegmentJs.ao));
parcelHelpers.export(exports, "_boundSegment", ()=>(0, _helpersSegmentJs.aw));
parcelHelpers.export(exports, "_boundSegments", ()=>(0, _helpersSegmentJs.am));
parcelHelpers.export(exports, "_capitalize", ()=>(0, _helpersSegmentJs.a4));
parcelHelpers.export(exports, "_computeSegments", ()=>(0, _helpersSegmentJs.al));
parcelHelpers.export(exports, "_createResolver", ()=>(0, _helpersSegmentJs.a8));
parcelHelpers.export(exports, "_decimalPlaces", ()=>(0, _helpersSegmentJs.aI));
parcelHelpers.export(exports, "_deprecated", ()=>(0, _helpersSegmentJs.aR));
parcelHelpers.export(exports, "_descriptors", ()=>(0, _helpersSegmentJs.a9));
parcelHelpers.export(exports, "_elementsEqual", ()=>(0, _helpersSegmentJs.ag));
parcelHelpers.export(exports, "_factorize", ()=>(0, _helpersSegmentJs.N));
parcelHelpers.export(exports, "_filterBetween", ()=>(0, _helpersSegmentJs.aK));
parcelHelpers.export(exports, "_getParentNode", ()=>(0, _helpersSegmentJs.G));
parcelHelpers.export(exports, "_int16Range", ()=>(0, _helpersSegmentJs.V));
parcelHelpers.export(exports, "_isBetween", ()=>(0, _helpersSegmentJs.ai));
parcelHelpers.export(exports, "_isClickEvent", ()=>(0, _helpersSegmentJs.ah));
parcelHelpers.export(exports, "_isDomSupported", ()=>(0, _helpersSegmentJs.L));
parcelHelpers.export(exports, "_isPointInArea", ()=>(0, _helpersSegmentJs.B));
parcelHelpers.export(exports, "_limitValue", ()=>(0, _helpersSegmentJs.w));
parcelHelpers.export(exports, "_longestText", ()=>(0, _helpersSegmentJs.aJ));
parcelHelpers.export(exports, "_lookup", ()=>(0, _helpersSegmentJs.aL));
parcelHelpers.export(exports, "_lookupByKey", ()=>(0, _helpersSegmentJs.x));
parcelHelpers.export(exports, "_measureText", ()=>(0, _helpersSegmentJs.U));
parcelHelpers.export(exports, "_merger", ()=>(0, _helpersSegmentJs.aP));
parcelHelpers.export(exports, "_mergerIf", ()=>(0, _helpersSegmentJs.aQ));
parcelHelpers.export(exports, "_normalizeAngle", ()=>(0, _helpersSegmentJs.ax));
parcelHelpers.export(exports, "_parseObjectDataRadialScale", ()=>(0, _helpersSegmentJs.y));
parcelHelpers.export(exports, "_pointInLine", ()=>(0, _helpersSegmentJs.ap));
parcelHelpers.export(exports, "_readValueToProps", ()=>(0, _helpersSegmentJs.aj));
parcelHelpers.export(exports, "_rlookupByKey", ()=>(0, _helpersSegmentJs.A));
parcelHelpers.export(exports, "_setMinAndMaxByKey", ()=>(0, _helpersSegmentJs.aE));
parcelHelpers.export(exports, "_steppedInterpolation", ()=>(0, _helpersSegmentJs.an));
parcelHelpers.export(exports, "_steppedLineTo", ()=>(0, _helpersSegmentJs.aq));
parcelHelpers.export(exports, "_textX", ()=>(0, _helpersSegmentJs.aA));
parcelHelpers.export(exports, "_toLeftRightCenter", ()=>(0, _helpersSegmentJs.a0));
parcelHelpers.export(exports, "_updateBezierControlPoints", ()=>(0, _helpersSegmentJs.ak));
parcelHelpers.export(exports, "addRoundedRectPath", ()=>(0, _helpersSegmentJs.at));
parcelHelpers.export(exports, "almostEquals", ()=>(0, _helpersSegmentJs.aH));
parcelHelpers.export(exports, "almostWhole", ()=>(0, _helpersSegmentJs.aG));
parcelHelpers.export(exports, "callback", ()=>(0, _helpersSegmentJs.Q));
parcelHelpers.export(exports, "clearCanvas", ()=>(0, _helpersSegmentJs.ae));
parcelHelpers.export(exports, "clipArea", ()=>(0, _helpersSegmentJs.X));
parcelHelpers.export(exports, "clone", ()=>(0, _helpersSegmentJs.aO));
parcelHelpers.export(exports, "color", ()=>(0, _helpersSegmentJs.c));
parcelHelpers.export(exports, "createContext", ()=>(0, _helpersSegmentJs.h));
parcelHelpers.export(exports, "debounce", ()=>(0, _helpersSegmentJs.ac));
parcelHelpers.export(exports, "defined", ()=>(0, _helpersSegmentJs.j));
parcelHelpers.export(exports, "distanceBetweenPoints", ()=>(0, _helpersSegmentJs.aD));
parcelHelpers.export(exports, "drawPoint", ()=>(0, _helpersSegmentJs.as));
parcelHelpers.export(exports, "each", ()=>(0, _helpersSegmentJs.E));
...
parcelHelpers.export(exports, "fontString", ()=>(0, _helpersSegmentJs.aW));
parcelHelpers.export(exports, "formatNumber", ()=>(0, _helpersSegmentJs.o));
parcelHelpers.export(exports, "getAngleFromPoint", ()=>(0, _helpersSegmentJs.C));
parcelHelpers.export(exports, "getHoverColor", ()=>(0, _helpersSegmentJs.aN));
parcelHelpers.export(exports, "getMaximumSize", ()=>(0, _helpersSegmentJs.F));
parcelHelpers.export(exports, "getRelativePosition", ()=>(0, _helpersSegmentJs.z));
parcelHelpers.export(exports, "getRtlAdapter", ()=>(0, _helpersSegmentJs.ay));
parcelHelpers.export(exports, "getStyle", ()=>(0, _helpersSegmentJs.aV));
parcelHelpers.export(exports, "isArray", ()=>(0, _helpersSegmentJs.b));
parcelHelpers.export(exports, "isFinite", ()=>(0, _helpersSegmentJs.g));
parcelHelpers.export(exports, "isFunction", ()=>(0, _helpersSegmentJs.a6));
parcelHelpers.export(exports, "isNullOrUndef", ()=>(0, _helpersSegmentJs.k));
parcelHelpers.export(exports, "isNumber", ()=>(0, _helpersSegmentJs.q));
parcelHelpers.export(exports, "isObject", ()=>(0, _helpersSegmentJs.i));
parcelHelpers.export(exports, "isPatternOrGradient", ()=>(0, _helpersSegmentJs.aM));
parcelHelpers.export(exports, "listenArrayEvents", ()=>(0, _helpersSegmentJs.l));
parcelHelpers.export(exports, "log10", ()=>(0, _helpersSegmentJs.M));
parcelHelpers.export(exports, "merge", ()=>(0, _helpersSegmentJs.a3));
parcelHelpers.export(exports, "mergeIf", ()=>(0, _helpersSegmentJs.aa));
parcelHelpers.export(exports, "niceNum", ()=>(0, _helpersSegmentJs.aF));
parcelHelpers.export(exports, "noop", ()=>(0, _helpersSegmentJs.aC));
parcelHelpers.export(exports, "overrideTextDirection", ()=>(0, _helpersSegmentJs.az));
parcelHelpers.export(exports, "readUsedSize", ()=>(0, _helpersSegmentJs.I));
parcelHelpers.export(exports, "renderText", ()=>(0, _helpersSegmentJs.Y));
...
parcelHelpers.export(exports, "restoreTextDirection", ()=>(0, _helpersSegmentJs.aB));
parcelHelpers.export(exports, "retinaScale", ()=>(0, _helpersSegmentJs.ad));
parcelHelpers.export(exports, "setsEqual", ()=>(0, _helpersSegmentJs.af));
parcelHelpers.export(exports, "sign", ()=>(0, _helpersSegmentJs.s));
parcelHelpers.export(exports, "splineCurve", ()=>(0, _helpersSegmentJs.aT));
parcelHelpers.export(exports, "splineCurveMonotone", ()=>(0, _helpersSegmentJs.aU));
parcelHelpers.export(exports, "supportsEventListenerOptions", ()=>(0, _helpersSegmentJs.K));
parcelHelpers.export(exports, "throttled", ()=>(0, _helpersSegmentJs.J));
parcelHelpers.export(exports, "toDegrees", ()=>(0, _helpersSegmentJs.S));
parcelHelpers.export(exports, "toDimension", ()=>(0, _helpersSegmentJs.n));
parcelHelpers.export(exports, "toFont", ()=>(0, _helpersSegmentJs.$));
parcelHelpers.export(exports, "toFontString", ()=>(0, _helpersSegmentJs.aS));
parcelHelpers.export(exports, "toLineHeight", ()=>(0, _helpersSegmentJs.aX));
parcelHelpers.export(exports, "toPadding", ()=>(0, _helpersSegmentJs.D));
...
parcelHelpers.export(exports, "toTRBL", ()=>(0, _helpersSegmentJs.au));
parcelHelpers.export(exports, "toTRBLCorners", ()=>(0, _helpersSegmentJs.av));
parcelHelpers.export(exports, "uid", ()=>(0, _helpersSegmentJs.ab));
parcelHelpers.export(exports, "unclipArea", ()=>(0, _helpersSegmentJs.Z));
...
},{"./chunks/helpers.segment.js":"7oQuk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kMtu7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ function getEnabledScalesByPoint(mode, point, chart) {
    ...
    if (scale && directionEnabled(mode, scale.axis, chart)) return [
        scale
    ];
    const enabledScales = [];
    (0, _helpers.each)(chart.scales, function(scaleItem) {
        if (!directionEnabled(mode, scaleItem.axis, chart)) enabledScales.push(scaleItem);
    });
...
function zoomDelta(scale, zoom1, center) {
...
function zoomNumericalScale(scale, zoom3, center, limits) {
    const delta = zoomDelta(scale, zoom3, center);
    const newRange = {
...
function zoomCategoryScale(scale, zoom4, center, limits) {
    const delta = zoomDelta(scale, zoom4, center);
    if (scale.min === scale.max && zoom4 < 1) existCategoryFromMaxZoom(scale);
    const newRange = {
...
function zoomRect(chart, p0, p1, transition = "none") {
    ...
    (0, _helpers.each)(chart.scales, function(scale) {
        if (scale.isHorizontal() && xEnabled) updateRange(scale, getRange(scale, p0.x, p1.x), limits, true);
        else if (!scale.isHorizontal() && yEnabled) updateRange(scale, getRange(scale, p0.y, p1.y), limits, true);
    });
    chart.update(transition);
    (0, _helpers.callback)(zoomOptions.onZoom, [
        {
...
function mouseDown(chart, event) {
    ...
    if (keyPressed(getModifierKey(panOptions), event) || keyNotPressed(getModifierKey(zoomOptions.drag), event)) return (0, _helpers.callback)(zoomOptions.onZoomRejected, [
        {
            chart,
            event
        }
...
},{"hammerjs":"lHwvQ","chart.js/helpers":"7mXAh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lHwvQ":[function(require,module,exports) {
...
},{}]},["1JEHZ","adjPd"], "adjPd", "parcelRequire717a")
